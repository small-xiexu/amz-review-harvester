...
| 翻译 | 导出前翻译标题和正文为中文，翻译进度分段写回本地；失败项导出时留空 |
...
| AI 分析报告 | 调用 OpenAI / Claude，基于成功翻译评论生成痛点、亮点、使用场景、改品建议、Listing 卖点的 HTML 报告 |
...
- 需要分析时，点击 `生成 AI 报告`
- AI 报告准备好后，点击 `下载 AI 报告`，直接下载 HTML 分析报告
